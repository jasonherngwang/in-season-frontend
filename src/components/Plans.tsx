...
const plans = [
  {
    ...
    emphasize: false,
    imageUrl: 'https://d30lu1rnmhqi8p.cloudfront.net/base/apricot.webp',
    price: 'ALWAYS FREE',
    extra: '',
  },
  {
    ...
    emphasize: true,
    imageUrl: 'https://d30lu1rnmhqi8p.cloudfront.net/base/fig.webp',
  ...
  },
  {
    ...
    emphasize: false,
    imageUrl: 'https://d30lu1rnmhqi8p.cloudfront.net/base/dragonfruit.webp',
